  ...
  (with-temp-buffer
    ...
    (unwind-protect
        (let ((rpc-calls nil))
          ...
          (should (string-match-p "Footer: ~/psi-main | latency 12ms" (buffer-string)))
          ...
          (should-not (string-match-p "Footer:" (buffer-string)))
          (should-not (psi-emacs-state-projection-footer psi-emacs--state))

...
(def ^:private tool-def
  {:name               "edit-clj"
   ...
   :lambda-description "λ{filename old-string new-string}. replace_form(filename, old-string, new-string) | match(structural_equality(old-string)) ∧ whitespace_irrelevant ∧ parseable_form(old-string) ∧ parseable_form(new-string)"

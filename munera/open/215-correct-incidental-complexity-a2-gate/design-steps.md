...
- [ ] Resolve A2/A3 enforcement asymmetry: specify how A2a/A2b are mechanically
...
- [ ] Justify (or remove) the tunable margins θ (and optional ε): explain why a
...
- [ ] Reconcile the criterion taxonomy with the live emitter: the emitted contract

...
- [ ] Define the pre-optimization instrumentation seam: either add named helper wrappers for full redraw, stream property application, and prefix overlay creation before optimization, or explicitly allow primitive-level advice in tests and state which primitives/ranges are authoritative.

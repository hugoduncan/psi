...
- [ ] Align assistant divergent snapshot acceptance wording with the explicit payload contract, plan, and steps: divergent assistant payloads preserve existing merge/append semantics after effective-next-text calculation, rather than requiring a redraw/replacement fallback.

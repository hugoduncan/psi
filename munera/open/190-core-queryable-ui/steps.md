...
- [ ] Add TUI lifecycle coverage proving `start-tui-runtime!` clears the active UI capability provider when `tui-start-fn!` throws, preventing stale attached UI advertisements after exceptional frontend shutdown.

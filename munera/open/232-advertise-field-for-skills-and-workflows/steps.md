...
- [ ] Flip enumerated review-*/issue-* skills to `advertise: false`.
- [ ] Flip enumerated sub-only workflows to `advertise: false`.
- [ ] Verify dropped from system context, still invocable.

...
- [ ] A1: Resolve the scope-decision criterion. State explicitly how the planner
...
- [ ] A2: Clarify whether the single-source "expressed once" contract must also
...
- [ ] A3: Specify, for direction 1 (remove), what behaviour must remain covered

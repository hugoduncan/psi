...
- [ ] Reclassify `psi.agent-session.prompt_request` in the affected-surface guidance: it should be audited for exact-name lookup behavior, not treated as a prompt/display/introspection surface that owns or consumes canonical skill-list ordering.

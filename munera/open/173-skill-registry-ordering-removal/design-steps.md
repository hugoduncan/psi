...
- [ ] Reconcile the `design-steps.md` follow-up-surface description across task artifacts so it explicitly covers inconsistency-review follow-up items as well as ambiguity-review follow-up items, matching the prior inconsistency pass and current review protocol.

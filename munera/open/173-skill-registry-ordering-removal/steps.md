...
- [ ] Add focused command tests proving `/skills` output and the `/help` Skills section render unsorted session `:skills` in canonical skill-name order rather than raw vector order.

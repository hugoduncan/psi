...
- [ ] Create `plan.md` and `steps.md` before implementation so the task has a concrete approach and checklist aligned with the finalized design acceptance criteria, including the required Emacs and TUI verification coverage.

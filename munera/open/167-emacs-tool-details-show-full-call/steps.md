...
- [ ] Normalize parsed/raw argument completeness comparison through a canonical argument-map shape so equivalent complete raw JSON and parsed Emacs args suppress unnecessary `Raw arguments:` fallback while projected or lossy parsed args still include raw fallback.

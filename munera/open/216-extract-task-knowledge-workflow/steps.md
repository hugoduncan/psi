...
- [ ] TT3: Add workflow-loader prompt content-lock coverage for the required task-artifact inspection surface: when present, the extraction prompt must read `design.md`, `plan.md`, `steps.md`, and `implementation.md` from the resolved task before mining knowledge.

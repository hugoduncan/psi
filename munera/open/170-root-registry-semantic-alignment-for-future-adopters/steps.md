...
- [ ] Add an alignment-focused deterministic-operation-registry test proving preserved registration-order behavior remains intact and adapter-owned independently of the new shared `root-registry` result semantics.

...
- [ ] Resolve the sibling-site contradiction: `persistence.clj` swallowed-error
...
- [ ] Specify whether `com.taoensso/timbre` must be added to
...
- [ ] Make the log-level choice determinable: since in-extension siblings carry
...
- [ ] Specify the replacement call's content contract: which fields (session-id,

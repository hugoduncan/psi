...
- [ ] Move `:scheduler/deliver` delivered-at resolution until after the target schedule has been found and the path actually needs to construct a scheduled user message, preserving schedule-not-found/non-deliverable error precedence.

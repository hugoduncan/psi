...
- `munera/open/250-opaque-delegated-workflow-error/` — propagate actionable child failure details instead of reporting only `"Delegated workflow failed"`. Design-only; auto-generated and pending human review.

...
- `munera/open/204-incidental-complexity-simplification-workflow/` — (from master) workflow to find and reduce incidental complexity. NNN collides with closed `204-prompts-reload-command-and-mutation` (left as-is per convention).

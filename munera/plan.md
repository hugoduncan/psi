...
- `munera/open/237-pre-turn-request-augmentation/` — design a core-owned critical-path pre-turn augmentation phase so context-manager can add recorded, turn-scoped request context before prompt execution. Design-only.

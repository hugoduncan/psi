...
- [x] Fix plan summary site count: reworded to "all lifecycle/init/test-helper sites listed in the design" to avoid a specific count that conflicted with the detailed steps

...
- `006` is the concrete implementation slice for the remaining unfinished prompt-lifecycle convergence work tracked by `003-prompt-lifecycle-architectural-convergence`.

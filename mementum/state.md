...
- Task 125 workflow-runtime core component extraction is now landed locally with follow-up decomposition, Kaocha wiring, and test-shaping polish complete:
  ...
  - removed overlapping runtime test surfaces, strengthened lifecycle behavior proofs, trimmed incidental setup from the working-memory seed test, and dropped the low-value lifecycle delegation test
  - verification green through focused top-level Kaocha checks: `7 tests, 24 assertions, 0 failures`; lint green `0 errors, 0 warnings`

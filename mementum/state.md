...
## Suggested next step
- For task 190, ambiguity follow-ups are resolved; next step is implementation of provider `parse-json-value` result preservation (including `:payload nil`) and structured-output judge retry opts retention.

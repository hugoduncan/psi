...
## Suggested next step
- For task 190, resolve the two design ambiguities before implementation: JSON `null` provider payload semantics, and structured-output opts/schema retention on judge retries.

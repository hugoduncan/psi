...
- 2026-05-30: Task 190 code-shaper review found one new actionable robustness gap: action descriptors reject unqualified/foreign extra keys but still allow extra same-namespace non-schema `:psi.ui.action/...` keys at the untrusted provider boundary. Added an unchecked follow-up; existing invocation same-namespace follow-up was not duplicated.

...
- Extensions can inject mid-conversation system instructions through `inject-mid-system-message!` / `psi.extension/inject-mid-system-message`, gated by the queryable `:psi.agent-session/model-supports-mid-system-messages` capability.
